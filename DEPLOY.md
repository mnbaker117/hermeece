...
5. Add a **Port** mapping: Host `8788` → Container `8788` (TCP)
...
user account — Hermeece is single-admin by design. The password is
...
### Unraid
Click the Hermeece container icon → **Update**. Unraid pulls the
